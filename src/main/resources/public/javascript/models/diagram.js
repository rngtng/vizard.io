define(["backbone"], function(Backbone)  {
  var DiagramModel = Backbone.Model.extend({
    initialize: function() {
      _.bindAll(this, 'updateImageData', 'setImageData');

      this.bind('change:data', this.updateImageData);
